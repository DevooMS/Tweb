                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;assets/img/dogs/image4.jpg&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="db_login.php" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <div class="custom-control custom-checkbox small">
                                                <!--<div class="form-check"><input class="form-check-input custom-control-input" type="checkbox" id="rember"><label class="form-check-label custom-control-label" for="rember">Remember Me <?php if(isset($_COOKIE["loginemail"])) { ?> checked <?php } ?>> Remember me</div> </label>-->
