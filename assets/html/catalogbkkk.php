	...
	<h2>Example: Datatables Add Edit Delete with Ajax, PHP & MySQL</h2>	
		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-md-2">
					<button type="button" name="add" id="addProduct" class="btn btn-success btn-xs">Add Product</button>
				</div>
			</div>
		</div>
		<table id="catalogList" class="table table-bordered table-striped">
			<thead>
				<tr>
					<th>Name Product</th>
					<th>Brand</th>
